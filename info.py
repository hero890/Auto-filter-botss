...
BOT_TOKEN = environ.get('BOT_TOKEN', "6614227021:AAGXstMQIVj2uDDd6dC5xlIfqiXhLNegc4c")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'what_if_dub')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", """<b>ɴᴀᴍᴇ: <code>{file_name}</code> \n\nJᴏɪɴ Nᴏᴡ: [⚡ sasta marvel⚡](https://t.me/what_if_season_2_hindi_dubb)</b>""")
